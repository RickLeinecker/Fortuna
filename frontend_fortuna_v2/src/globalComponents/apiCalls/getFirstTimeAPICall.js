...
function getFirstTimeAPICall(onLoad:(firstTime: Boolean) => void) {
    const token=getLoginToken();
    console.log('checking if this is the first time the user has visited this site...');
    const responsePromise: Promise<Response> = fetch('/api/user/getFirstTime', {
        method: 'GET',
        headers: {
...
export default getFirstTimeAPICall;
