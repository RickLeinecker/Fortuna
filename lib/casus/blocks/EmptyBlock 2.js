...
function (_CasusBlock) {
  _inherits(EmptyBlock, _CasusBlock);

  function EmptyBlock(dataType) {
    var _this;

    _classCallCheck(this, EmptyBlock);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EmptyBlock).call(this));
  ...
  _createClass(EmptyBlock, [{
    ...
    value: function precompBounds() {
      this.boundingBox = new _BoundingBox.default(0, 0, _generateCornerPerim.RAMP_WIDTH + _generateCornerPerim.EMPTY_STATEMENT_WIDTH + _generateCornerPerim.RAMP_WIDTH, _generateCornerPerim.EMPTY_STATEMENT_HEIGHT);
    }
  }, {
    key: "precompXY",
