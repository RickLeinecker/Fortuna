...
function verifyInt(val: ?Value): IntValue {
	if (val == null) {
		throw new Error('Expected an int value, but got null!');
	}
	if (!(val instanceof IntValue)) {
		throw new Error('Expected a int value, but didnt find one!');
	}
	return val;
}
...
function verifyBoolean(val: ?Value): BooleanValue {
	if (val == null) {
		throw new Error('Expected a boolean value, but got null!');
	}
	if (!(val instanceof BooleanValue)) {
		throw new Error('Expected a boolean value, but didnt find one!');
	}
	return val;
}
...
function verifyDouble(val: ?Value): DoubleValue {
	if (val == null) {
		throw new Error('Expected a double value, but got null!');
	}
	if (!(val instanceof DoubleValue)) {
		throw new Error('Expected a double value, but didnt find one!');
	}
	return val;
}
...
function verifyIntList(val: ?Value): IntListValue {
	if (val == null) {
		throw new Error('Expected an int list, but got null!');
	}
	if (!(val instanceof IntListValue)) {
		throw new Error('Expected a int list, but didnt find one!');
	}
	return val;
}
...
function verifyBooleanList(val: ?Value): BooleanListValue {
	if (val == null) {
		throw new Error('Expected a boolean leist, but got null!');
	}
	if (!(val instanceof BooleanListValue)) {
		throw new Error('Expected a boolean list, but didnt find one!');
	}
	return val;
}
...
function verifyDoubleList(val: ?Value): DoubleListValue {
	if (val == null) {
		throw new Error('Expected a double list, but got null!');
	}
	if (!(val instanceof DoubleListValue)) {
		throw new Error('Expected a double list, but didnt find one!');
	}
	return val;
}
