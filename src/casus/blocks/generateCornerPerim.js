...
const SET_LIST_AT_SET_WIDTH = 35;
const SET_LIST_AT_AT_WIDTH = 25;
const SET_LIST_AT_TO_WIDTH = 25;
const GET_LIST_AT_AT_WIDTH = 25;
const LIST_SIZE_SIZE_WIDTH = 35;
...
function generateCornerPerim(boundingBox: BoundingBox, dataType: DataType): Array<Vec> {
	...
	if (dataType==='INT_LIST') return _generateIntListPerim(boundingBox);
	if (dataType==='DOUBLE_LIST') return _generateDoubleListPerim(boundingBox);
	if (dataType==='BOOLEAN_LIST') return _generateBooleanListPerim(boundingBox);
